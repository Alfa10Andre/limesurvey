    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div  class="col-xs-6 col-sm-4 text-center" >
                <a >
                    <img alt='<?php printf(gT("Support this project"), 'Edudigital'); ?>' title='<?php printf(gT("Support this project - Donate to %s!"), 'Edudigital'); ?>' src='<?php echo Yii::app()->getConfig('adminimageurl');?>donate.png'/>
                </a>
            </div>
